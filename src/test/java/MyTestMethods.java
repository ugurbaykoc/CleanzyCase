...
public class MyTestMethods {
    ...
    public void Setup() {
        ...
        driver.get("https://cleanzy.com/uk-en/login");

    }

    public void VerifyPageTitle() {
        String ActualTitle = driver.getTitle();
        String ExpectedTitle = "Sign-Up - cleanzy.com";
    ...
    {
        boolean facebookButtonPresent = driver.findElement(By.linkText("Login")).isDisplayed();
    ...
    {
        boolean forgetPasswordLinkVisible = driver.findElement(By.linkText("Forgot My Password")).isDisplayed();
    ...
    public void Login()
    {
        ...
        String actualUrl ="https://cleanzy.com/uk-en/#fromLogin=1";
